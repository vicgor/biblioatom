...
Реализует :class:`~biblioatom.services.EpubBuilderProtocol`. Структура: главы →
XHTML-секции, TOC, встраивание изображений, дедупликация манифеста; разметку и
упаковку ZIP строит EbookLib, а не ручной ``zipfile``.
